...
\begin{document}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item Relevant technical requirements for this evolution of the Architecture Development Cycle
			\item Constraints on the Technology Architecture to be designed
